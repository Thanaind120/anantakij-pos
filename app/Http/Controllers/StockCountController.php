...
class StockCountController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if( count($lims_product_list) ){
            ...
            $file_path= public_path().'/storage/stock_count/'.$filename;
    ...
    public function finalize(Request $request)
    {
        ...
        $document->move('storage/stock_count/', $documentName);
    ...
    public function stockDif($id)
    {
        ...
        $file_handle = fopen('storage/stock_count/'.$lims_stock_count_data->final_file, 'r');
        $i = 0;
        $temp_dif = -1000000;
        $data = [];
        $product = [];
