...
<html>
  <head>
    ...
    <link rel="preload" href="<?php echo asset('storage/vendor/keyboard/css/keyboard.css') ?>" as="style" onload="this.onload=null;this.rel='stylesheet'">
    <noscript><link href="<?php echo asset('storage/vendor/keyboard/css/keyboard.css') ?>" rel="stylesheet"></noscript>
  ...
  <body onload="myFunction()">
    ...
    <script type="text/javascript" src="<?php echo asset('storage/vendor/keyboard/js/jquery.keyboard.js') ?>"></script>
    <script type="text/javascript" src="<?php echo asset('storage/vendor/keyboard/js/jquery.keyboard.extension-autocomplete.js') ?>"></script>
    <script type="text/javascript" src="<?php echo asset('storage/js/grasp_mobile_progress_circle-1.0.0.min.js') ?>"></script>
