            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <a href="{{ asset('storage/sample_file/sample_category.csv') }}" class="btn btn-info btn-block btn-md"><i class="dripicons-download"></i>  {{trans('file.Download')}}</a>
                    </div>
                </div>
            </div>
            <input type="submit" value="{{trans('file.submit')}}" class="btn btn-primary">
...
<script type="text/javascript">
    ...
    $(document).on("click", ".open-EditCategoryDialog", function(){
          ...
          $.get(url, function(data){
            ...
            $("#editModal input[name='old_image']").val(data['image']);
