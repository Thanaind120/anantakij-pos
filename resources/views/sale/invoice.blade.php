...
<html>
  <head>
    ...
    <link rel="icon" type="image/png" href="{{url('storage/logo', $general_setting->site_logo)}}" />
    ...
    <div id="receipt-data">
        <div class="centered">
            @if($general_setting->site_logo)
                <img src="{{url('storage/logo', $general_setting->site_logo)}}" height="42" width="50" style="margin:10px 0;filter: brightness(0);">
            @endif
