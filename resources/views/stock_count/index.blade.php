        ...
        <table id="stock-count-table" class="table stock-count-list">
            ...
            <tbody>
                ...
                <?php
                    ...
                    $category_name = [];
                    $brand_name = [];
                    $initial_file = 'storage/stock_count/' . $stock_count->initial_file;
                    $final_file = 'storage/stock_count/' . $stock_count->final_file;
                ?>
                <tr>
                    <td>{{$key}}</td>
                    ...
                    <td class="text-center">
                        <a download href="{{'storage/stock_count/'.$stock_count->initial_file}}" title="{{trans('file.Download')}}"><i class="dripicons-copy"></i></a>
                    </td>
                    <td class="text-center">
                        @if($stock_count->final_file)
                        <a download href="{{'storage/stock_count/'.$stock_count->final_file}}" title="{{trans('file.Download')}}"><i class="dripicons-copy"></i></a>
                        @endif
                    </td>
                    <td>
                        @if($stock_count->final_file)
