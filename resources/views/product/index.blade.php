           ...
           <div class="row">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <a href="{{ asset('storage/sample_file/sample_products.csv') }}" class="btn btn-info btn-block btn-md"><i class="dripicons-download"></i>  {{trans('file.Download')}}</a>
                    </div>
                </div>
           </div>
...
<script>
    ...
    $("#print-btn").on("click", function() {
          ...
          newWin.document.write('<link rel="stylesheet" href="<?php echo asset('storage/vendor/bootstrap/css/bootstrap.min.css') ?>" type="text/css"><style type="text/css">@media print {.modal-dialog { max-width: 1000px;} }</style><body onload="window.print()">'+divToPrint.innerHTML+'</body>');
