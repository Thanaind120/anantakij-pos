        ...
        <table id="report-table" class="table table-hover">
            <thead>
                <tr>
                    ...
                    @foreach ($product_warehouse as $warehouse)
                    ...
                    @foreach($product_id as $key => $pro_id)
                        <tr>
                            ...
                            <?php
                                ...
                                $product_sale_data = DB::table('product_sales')->where('product_id', $pro_id)
                            ...
                            @foreach ($product_warehouse as $warehouse)
                                <?php
                                    $product_warehouse_qty = DB::table('product_warehouse')->where([
                                        ['product_warehouse.warehouse_id', $warehouse->id],
                                        ['product_warehouse.product_id', $pro_id]
                                    ])->first();

                                ?>
                                
                                @if ($product_warehouse_qty)
                                <td>{{ $product_warehouse_qty->qty }}</td>  
                                @else
                                    <td></td>
                                @endif
                            @endforeach
